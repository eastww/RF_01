...
clean-Bsp-2f-config:
	-$(RM) ./Bsp/config/rf_cfg.cyclo ./Bsp/config/rf_cfg.d ./Bsp/config/rf_cfg.o ./Bsp/config/rf_cfg.su ./Bsp/config/uart_cfg.cyclo ./Bsp/config/uart_cfg.d ./Bsp/config/uart_cfg.o ./Bsp/config/uart_cfg.su
