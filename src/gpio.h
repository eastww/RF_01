...
/* define led function */
#define led1On()               	HAL_GPIO_WritePin(LED1_PORT, LED1_PIN, GPIO_PIN_SET)
...
#define led1Toggle()           	do{led1Off(); Delay_Ms(2); led1On();} while (0)
#define led2Toggle()           	do{led2Off(); Delay_Ms(2); led2On();} while (0)
